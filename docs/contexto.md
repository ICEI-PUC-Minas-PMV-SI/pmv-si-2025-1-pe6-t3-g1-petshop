...
Gerenciamento de Pets: O usuário poderá cadastrar, editar e excluir pets na plataforma. Para cadastrar, deverá informar o CPF do cliente que possui o pet e preencher um formulário com a raça, o nome, a cor e, opcionalmente, observações. Esse cadastro enviará uma requisição do tipo POST será enviada para a API REST, que encaminhará os dados para o backend, onde serão registrados no banco de dados PostgreSQL. Para editar, o usuário deverá buscar o CPF do cliente que possui o pet, selecionar o pet que deseja editar e preencher apenas os campos que deseja alterar, utilizando o mesmo formulário de cadastro. Essa edição enviará uma requisição do tipo PATCH para a API REST, que encaminhará os dados para o backend, onde serão alterados no banco de dados PostgreSQL. Para excluir, basta selecionar o pet e clicar no botão excluir, seguido do botão confirmar, isso enviará uma requisição do tipo DELETE para a API REST, que encaminhará os dados para o backend, onde serão excluídos no banco de dados PostgreSQL.

Gerenciamento de Serviços: o usuário poderá agendar um serviço associado a um pet, iniciando com a busca do cliente pelo CPF, selecionando o pet desejado e escolhendo um serviço a partir da lista disponível. Ao selecionar o serviço, uma agenda com os horários disponíveis para os próximos dias será exibida, e, após a escolha do dia e horário, a confirmação enviará uma requisição do tipo POST para a API REST, que encaminhará os dados para o backend, registrando-os no banco de dados PostgreSQL. Além disso, o usuário tem a possibilidade de editar a data e o horário de um serviço agendado, realizando novamente a busca do cliente pelo CPF, selecionando o pet e clicando no botão "Alterar Data", o que abrirá uma agenda com os horários disponíveis; ao selecionar e confirmar o novo dia e horário, uma requisição do tipo PATCH será enviada para a API REST, que transmitirá os dados para o backend, efetivando as alterações no banco de dados PostgreSQL. Por fim, para cancelar um agendamento, o usuário deverá buscar o cliente pelo CPF, selecionar o pet e clicar no botão "Cancelar Agendamento", e após a confirmação, uma requisição do tipo DELETE será enviada para a API REST, que encaminhará os dados para o backend, onde o registro será removido do banco de dados PostgreSQL.
