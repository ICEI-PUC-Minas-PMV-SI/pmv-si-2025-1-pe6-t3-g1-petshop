import { SortableSchedulingTable } from '../datatableScheduling/SchedulingTable'
...
export default function Schedulings() {
  ...
  const handleRedirectToNewUser = () => {
    router.push('/cadastroScheduling')
  }
      ...
      <YStack f={1} jc="center" ai="center" p="$4">
        ...
        >
          <View flexDirection="row" justifyContent="space-between" alignItems="center" width="100%">
            ...
            <Button onPress={handleRedirectToNewUser} color="$blue10">Novo agendamento</Button>
          </View>
          <SortableSchedulingTable />{' '}
        </YStack>
      </YStack>
    </YStack>
  )
