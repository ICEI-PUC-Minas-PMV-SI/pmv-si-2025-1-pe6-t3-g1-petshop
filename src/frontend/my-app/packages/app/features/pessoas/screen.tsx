import { SortableTable } from '../datatablePessoas/PessoasTable'
      ...
      <YStack f={1} jc="center" ai="center" p="$4">
        ...
        >
          <View flexDirection="row" justifyContent="space-between" alignItems="center" width="100%">
            ...
            <Button onPress={handleRedirectToNewUser} color="$blue10">Nova Pessoa</Button>
          </View>
          <SortableTable />{' '}
        </YStack>
      </YStack>
